...
;  infile='/home/gene/mrk273/NONAS/mrk273_mosaic.fits'
  infile='/home/yuteng/f05189/redux/mosaic/mosaic.fits'
...
;           '[OIII]4959', '[OIII]5007', '[NI]5200']
    lines = ['[OII]3726','[OII]3729', '[NeIII]3869',$
          'Hgamma', 'Hbeta',$
          '[OIII]4959', '[OIII]5007']
...
; Parameters for emission line plotting
  linoth = strarr(1,4)
  linoth[0,0] = '[OII]3726'
  linoth[0,1] = '[NeIII]3869'
  linoth[0,3] = '[OIII]5007'
...
;                 linoth: linoth}
    argspltlin1 = {nx: 2, ny: 2,$
                 label: ['[OII]3726,3729',$
			 '[NeIII]3869',$
                         'Hbeta','[OIII]5007'],$
                 wave: [3727,3869,4686,5007],$
                 off: [[-100,100],[-100,100],[-100,100],[-100,100]],$
                 linoth: linoth}
...
;                       gal+'hosttemplate.xdr', $
         startempfile: '/raid/KCWI/AGN_outflows/F05189/r1_acoil/F05189_starlighttemplate.xdr', $
...
;                          platescale: 0.025d,$
;                          nucoffset: [0d,0d]},$
;                  rangefile: '/home/gene/mrk273/NONAS/ifsfit_full/'+$
;                             'ranges.txt',$
                  fluxunits: 1d-16 $
                 }
   endif
